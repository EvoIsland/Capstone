      ...
      <div class="auth-card animated-entry">
        <div class="card-content">
          ...
          <div class="card-left">
            ...
            <p class="subtitulo">Ingresa tu correo y te enviaremos instrucciones</p>
          </div>
          ...
          <div class="card-right">
            <form @submit.prevent="handleSubmit" class="form-container">
              ...
              <button type="submit" class="btn-primary" :disabled="loading">
                ...
                <Icon v-if="!loading" icon="mdi:send-outline" width="20" />
              </button>

              <div v-if="mensaje" class="status-message" :class="esError ? 'error' : 'success'">
                <Icon :icon="esError ? 'mdi:alert-circle' : 'mdi:check-circle'" width="20" />
                {{ mensaje }}
              </div>
...
const handleSubmit = async () => {
  ...
  try {
    const res = await fetch(`${apiUrl}/request-password-change`, {
      method: 'POST',
    ...
    mensaje.value = data.message || 'Solicitud enviada. Revisa tu correo.'
    esError.value = false
  } catch (e: any) {
    mensaje.value = e.message || 'Error de conexión con el servidor'
    esError.value = true
  } finally {
    loading.value = false
  }
